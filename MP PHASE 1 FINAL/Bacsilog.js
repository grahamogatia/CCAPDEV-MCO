...
function deleteComment(commentContainer) {
  ...
  var replyText1 = "I absolutely loved Ate Rica's Bacsilog! The combination of crispy bacon, runny fried egg, and garlicky fried rice was pure perfection. The flavors blended beautifully, and the portion size was generous. It's definitely my go-to breakfast spot now!";
  ...
  var replyText1 = "Overcooked and burnt bacon, flavorless fried rice, and undercooked egg can certainly detract from the overall enjoyment of the dish.";
  var upvoteCountCOM1 = 3;
  var downvoteCountCOM1 = 2;
  ...
  var replyText1 = "The crispy bacon, garlicky fried rice, and well-cooked egg are indeed appealing elements. While it may not have exceeded your expectations, it's still a satisfying and straightforward breakfast option.";
  var upvoteCountCOM1 = 3;
  var downvoteCountCOM1 = 2;
  ...
  var replyText1 = "It seems like Ate Rica's Bacsilog might be a convenient choice for a quick bite, but it may not be worth going out of your way for.";
  var upvoteCountCOM1 = 3;
  var downvoteCountCOM1 = 2;
  ...
  var replyText1 = "It's wonderful when a breakfast dish can consistently satisfy your cravings.";
  var upvoteCountCOM1 = 3;
  var downvoteCountCOM1 = 2;
